    ...
    return(
      <section>
        ...
        <section>
          ...
          <div>
            <Link href={`./week-9/shopping-list`} className="m-4 p-4 bg-neutral-700 rounded hover:text-blue-400 hover:cursor-pointer hover:underline">Continue to shopping list</Link>
          </div>
        </section>
      </section>
    );
